...
public class HttpClientMain {
	...
	public static void main(String[] args) throws Exception {
		...
		HttpGet get = new HttpGet("https://inthub.stage.auctionintegrationhub.com/ChryslerDataExchange/getFileList");
